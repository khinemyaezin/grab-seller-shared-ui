export const routes = {
  ...
  admin: {
    ...
    zones: (locationId: string) => `/dashboard/locations/${locationId}/zones`,
    newZone: (locationId: string) => `/dashboard/locations/${locationId}/zones/new`,
    editZone: (locationId: string, zoneId: string) => `/dashboard/locations/${locationId}/zones/${zoneId}`,
    newBin: (locationId: string, zoneId: string) => `/dashboard/locations/${locationId}/zones/${zoneId}/bins/new`,
